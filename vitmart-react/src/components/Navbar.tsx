...
import {
  ...
  LogOut, Moon, Sun, ChevronDown, Home, ShieldCheck, Package,
} from 'lucide-react'
                        ...
                        <div className="px-4 py-3.5 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/40 dark:to-indigo-950/40 border-b border-border">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              <p className="font-bold text-sm text-foreground">User</p>
                              <p className="text-xs text-muted-foreground truncate">user.22ece@vit.ac.in</p>
                            </div>
                          </div>
